...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      bxdSelectOk(tab){
        this.bxd_ruleForm.project_manager={}
      ...
      bxd_submit(){
        ...
        setTimeout(()=>{
          if(this.picArr.length === 0 && this.fileArr.length === 0){
            ...
            let httpUrl = this.$test("/index.php/Mobile/approval/add_baoxiao")
            this.$http.post(httpUrl,param)
              .then((res)=>{
                var current = this
                var judge = res.data.code
      ...
      bxds_submit(){
        ...
        setTimeout(()=>{
          if(this.picArr.length == 0 && this.fileArr.length == 0){
            ...
            let httpUrl = this.$test('/index.php/Mobile/personal/add_baoxiao')
            this.$http.post(httpUrl,param)
              .then((res)=>{
                var current = this
                var judge = res.data.code
