...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      cpjSelectOk(tab) {
        this.cpj_ruleForm.project_manager ={}
      ...
      cpj_submit() {
        ...
        setTimeout(() => {
          if(this.picArr.length === 0 && this.fileArr.length === 0) {
            ...
            let httpUrl = this.$test("/index.php/Mobile/approval/add_chengpi")
            this.$http.post(httpUrl, param)
              .then((res) => {
                var current = this
                var judge = res.data.code
      ...
      cpjs_submit(){
        ...
        setTimeout(()=>{
          if(this.picArr.length == 0 && this.fileArr.length == 0){
            ...
            let httpUrl = this.$test('/index.php/Mobile/personal/add_personal_chengpi')
            this.$http.post(httpUrl,param)
              .then((res)=>{
                var current = this
                var judge = res.data.code
