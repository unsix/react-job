	...
	<div class="jurisdictionManage_wrapper">
		<div class="jurisdictionManage">
			...
			<div class="wrapper">
				...
				<jurisdictionItem v-show="jurisdictionItemShow" :formType="formType" @reload="reload" :submitAddPersonShow="submitAddPersonShow" :jurisdictionFormList="jurisdictionFormList">
				</jurisdictionItem>
