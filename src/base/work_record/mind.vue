<template>
  <div>
    <div class="mind" v-show="mindShow">
      ...
      <div class="main_wei" v-show="idx == 0">
        <ul>
      ...
      <div class="main_yi"  v-show="idx == 1">
        <ul>
          <li v-for="item in untreated">
            <div class="main">
              <div class="avatar">
            ...
            <div class="cc">
              <div class="cs">
                <span @click="masked(item.publish_id)"><i class="iconfont icon-shixindiqiu" style="margin-right: 5px"></i>{{item.cc_detail}}</span>
                <cc_per class="cc_per" ref="cc_persd" :pub="item.publish_id" ></cc_per>
              </div>
            </div>
            <div class="bottom" v-show="item.form_type == 1">
              <div class="time">
  ...
  export default {
    ...
    methods:{
      ...
      _get_mind(){
        ...
        param.append('company',this.nowCompanyId)
        param.append('type',1)
