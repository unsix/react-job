<template>
  <div>
    <div class="my" v-show="myRecord">
      <div class="top">
        <el-button type="primary" class="btn" size="small" @click="_remain" plain >返回</el-button>
    ...
    <div class="more" v-show="moreShow">
      <div class="top">
        <el-button type="primary" size="small" class="btn" plain @click="reinfo">返回</el-button>
...
export default {
  ...
  methods:{
    ...
    _get_return(){
      ...
      param.append("look_uid",this.user.uid)
      param.append("p",this.pageIndex)
      param.append("each",'10')
      param.append("type","1")
      let httpUrl = this.$test("/index.php/Mobile/company/personnel_publish_list")
