  ...
  <div name="工资单">
    <div class="form" v-show="mainShow">
      ...
      <div>
        ...
        <ul class="salary_items" v-show="untreated.length > 0">
    ...
    <div class="main">
      <detail_ele v-if="detail_ele_show" :content="detail_data" :btnShow="btnShow" @return_per="return_per"></detail_ele>
      <detail_fix v-if="detail_fix_show" :content="detail_data" :btnShow="btnShow" @return_per="return_per"></detail_fix>
    </div>
